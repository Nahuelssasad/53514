...
public class grammarProjectLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"FLOW", "STATE", "START", "END", "ROLE", "CAN", "CREATE", "REFUSE", "REVISE", 
			"APPROVE", "ARCHIVE", "FROM", "TO", "WHEN", "ACTION", "ASSIGN", "REGISTER", 
			"NOTIFY", "WITH", "BOOLEAN", "SEMICOLON", "LPAREN", "RPAREN", "ASSIGNVALUE", 
			"ISEQUAL", "DOT", "LBRACKET", "RBRACKET", "LBRACE", "RBRACE", "COMMA", 
			"DOBLEQUOTE", "COLON", "STRING", "DIGIT", "LETTER", "ID", "NUMBER", "WS"
		};
	}
	...
	public grammarProjectLexer(CharStream input) {
		super(input);
